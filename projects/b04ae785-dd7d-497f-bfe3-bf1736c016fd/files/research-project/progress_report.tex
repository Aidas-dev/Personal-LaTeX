...
\item \textbf{Individual Punishment}: Players can punish free-riders at personal cost (Fehr and Gächter, 2000)
\item \textbf{Collective Tax}: Automatic 20\% tax on uncontributed endowment
\item \textbf{Individual Reward}: Players can reward cooperators at personal cost (Sefton et al., 2007)
\item \textbf{Collective Bonus}: Automatic rewards for top contributors (Tao et al., 2016)
\end{enumerate}
...
\end{equation}
where $B_i$ is bonus from pool distributed to top contributors.
\end{itemize}
...
\begin{itemize}
\item Varying group sizes
\item Introducing institutional cost differentials
\end{itemize}
